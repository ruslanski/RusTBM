...
#https://github.com/ruslanski/RusTMB
...
class Application(tk.Tk):
    ...
    def logo(self):
        ...
        lblInfo=Label(root, font=('arial',20,'bold'), text="RusTMB Helpdesk Tools",fg="Steel blue",bg="white smoke")
        #Place Top Logo
    ...
    def tab_buttons(self):
         ...
         """
         tab1 = Frame(note, bg="steel blue")
         tab2 = Frame(note, bg="steel blue")
         tab3 = Frame(note,bg="steel blue")
         tab4 = Frame(note,bg="steel blue")
         ...
         btn1=Button(tab1,padx=40,bd=2,fg="black",font=('arial',9,'bold'),text="Crystal Disk",bg="light cyan",command=lambda: links.L.btnClick(Crystaldisk,CrystaldiskFile))
         ...
         btn2=Button(tab1,padx=35,bd=2,fg="black",font=('arial',9,'bold'),text="HDD Guardian",bg="light cyan",command=lambda: links.L.btnClick(Hddguardian,HddguardianFile))
         ...
         btn3=Button(tab1,padx=39,bd=2,fg="black",font=('arial',9,'bold'),text="Victoria HDD",bg="light cyan",command=lambda: links.L.btnClick(Victoriahdd,VictoriahddFile))
         ...
         btn4=Button(tab1,padx=37,bd=2,fg="black",font=('arial',9,'bold'),text="Smart Degraf",bg="light cyan",command=lambda: links.L.btnClick(Smartdegraf,Smartdegraf))
         ...
         btn5=Button(tab1,padx=49,bd=2,fg="black",font=('arial',9,'bold'),text="Autoruns",bg="light cyan",command=lambda: links.L.btnClick(Autoruns,AutorunsFile))
         btn5.place(x=20, y=170)

         Siw=""
         SiwFile=""
         btn6=Button(tab1,padx=63,bd=2,fg="black",font=('arial',9,'bold'),text="SIW",bg="light cyan",command=lambda: links.L.btnClick(Siw,SiwFile))
         btn6.place(x=20,y=210)
         
         Ccleaner="https://drive.google.com/uc?export=download&id=0B06Qp2heoHZkaENpYnhKQlVSeG8"
         CcleanerFile="Ccleaner"
         btn7=Button(tab1,padx=49,bd=2,fg="black",font=('arial',9,'bold'),text="CCleaner",bg="light cyan",command=lambda: links.L.btnClick(Ccleaner,CcleanerFile))
         btn7.place(x=20,y=250)

         Cpuz="https://drive.google.com/uc?export=download&id=0B06Qp2heoHZkUm5JdXRic1FMN00"
         CpuzFile="Cpuz.exe"
         btn8=Button(tab1,padx=58,bd=2,fg="black",font=('arial',9,'bold'),text="CPU-Z",bg="light cyan",command=lambda: links.L.btnClick(Cpuz,CpuzFile))
         btn8.place(x=20,y=290)
         ...
         btn9=Button(tab1,padx=19,bd=2,fg="black",font=('arial',9,'bold'),text="Wise Data Recovery",bg="light cyan",command=lambda: links.L.btnClick(Wisedatarecovery,WisedatarecoveryFile))
         btn9.place(x=20, y=330)
         ...
         btn10=Button(tab1,padx=27,bd=2,fg="black",font=('arial',9,'bold'),text="Angry IP Scanner",bg="light cyan",command=lambda: links.L.btnClick(Angryipscanner,AngryipscannerFile))
         btn10.place(x=20, y=370)
         ...
         btn11=Button(tab1,padx=35,bd=2,fg="black",font=('arial',9,'bold'),text="PC Decrapifier",bg="light cyan",command=lambda: links.L.btnClick(Ipdecrapifier,IpdecrapifierFile))
         btn11.place(x=20, y=410)
         
         Restoration="https://drive.google.com/uc?export=download&id=0B06Qp2heoHZkZW5yMzJJUERiWDA"
         RestorationFile="Restoration.exe"
         btn12=Button(tab1,padx=43,bd=2,fg="black",font=('arial',9,'bold'),text="Restoration",bg="light cyan",command=lambda: links.L.btnClick(Restoration,RestorationFile))
         btn12.place(x=20,y=450)

         Restoration="https://drive.google.com/uc?export=download&id=0B06Qp2heoHZkZW5yMzJJUERiWDA"
         RestorationFile="Restoration.exe"
         btn88=Button(tab1,padx=43,bd=2,fg="black",font=('arial',9,'bold'),text="AnotherOne",bg="light cyan",command=lambda: links.L.btnClick(Restoration,RestorationFile))
         btn88.place(x=20,y=490)
         ...
         btn13=Button(tab1,padx=41,bd=2,fg="black",font=('arial',9,'bold'),text="WinDirStat",bg="light cyan",command=lambda: links.L.btnClick(Windirstat,WindirstatFile))
         ...
         btn14=Button(tab1,padx=23,bd=2,fg="black",font=('arial',9,'bold'),text="Console Portable",bg="light cyan",command=lambda: links.L.btnClick(Consoleportable,ConsoleportableFile))
         ...
         btn15=Button(tab1,padx=22,bd=2,fg="black",font=('arial',9,'bold'),text="Process Explorer",bg="light cyan",command=lambda: links.L.btnClick(Processexplorer,ProcessexplorerFile))
         ...
         btn16=Button(tab1,padx=46,bd=2,fg="black",font=('arial',9,'bold'),text="WinAudit",bg="light cyan",command=lambda: links.L.btnClick(Winaudit,WinauditFile))
         ...
         btn17=Button(tab1,padx=36,bd=2,fg="black",font=('arial',9,'bold'),text="Patch My PC",bg="light cyan",command=lambda: links.L.btnClick(Patchmypc,PatchmypcFile))
         ...
         btn18=Button(tab1,padx=10,bd=2,fg="black",font=('arial',9,'bold'),text="Sys Restore Manager",bg="light cyan",command=lambda: links.L.btnClick(Sysrestoremanager,SysrestoremanagerFile))
         ...
         btn19=Button(tab1,padx=40,bd=2,fg="black",font=('arial',9,'bold'),text="GPU Shark",bg="light cyan",command=lambda: links.L.btnClick(Gpushark,GpusharkFile))
         ...
         btn20=Button(tab1,padx=26,bd=2,fg="black",font=('arial',9,'bold'),text="GeekUninstaller",bg="light cyan",command=lambda: links.L.btnClick(Geekuninstaller,GeekuninstallerFile))
         ...
         btn21=Button(tab1,padx=50,bd=2,fg="black",font=('arial',9,'bold'),text="Recuva",bg="light cyan",command=lambda: links.L.btnClick(Recuva,RecuvaFile))
         ...
         btn22=Button(tab1,padx=27,bd=2,fg="black",font=('arial',9,'bold'),text="Win Utilites Pro",bg="light cyan",command=lambda: links.L.btnClick(Winutilities,WinutilitiesFile))
         ...
         btn23=Button(tab1,padx=10,bd=2,fg="black",font=('arial',9,'bold'),text="Win Repair All-in-One",bg="light cyan",command=lambda: links.L.btnClick(Winrepair,WinrepairFile))
         ...
         btn24=Button(tab1,padx=42,bd=2,fg="black",font=('arial',9,'bold'),text="TrueCrypt",bg="light cyan",command=lambda: links.L.btnClick(Truecrypt,TruecryptFile))
         btn24.place(x=230,y=450)

         Restoration="https://drive.google.com/uc?export=download&id=0B06Qp2heoHZkZW5yMzJJUERiWDA"
         RestorationFile="Restoration.exe"
         btn25=Button(tab1,padx=37,bd=2,fg="black",font=('arial',9,'bold'),text="AnotherOne",bg="light cyan",command=lambda: links.L.btnClick(Restoration,RestorationFile))
         btn25.place(x=230,y=490)
         ...
         #Place buttons in second column of tab2.
...
if __name__ == '__main__':
    ...
    root.title("RusTMB 0.0.7")
    #Size of Window Frame.
    root.geometry("400x660+0+0")
